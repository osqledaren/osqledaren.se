<?php
	...
	/*
		...
		Version: 99 (AKA uppgradera inte)
		Author: Bostjan Cigan (edit av Max Krog)
  ...
  <?php
	...
	function post_read_time($post_id) {
		...
		if($time == "1") {
			...
			$estimated_time = $estimated_time.' '.$minutes . ' min';
		}
		else {
	...
	class post_readtime_widget extends WP_Widget {
		...
		function post_readtime_widget() {
			...
			*/
			parent::__construct(false, "Post reading time");
		}
