...
$ads = $wpdb->get_results("SELECT id, name FROM {$aTable} WHERE trash IS FALSE", ARRAY_A);
?>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title><?php _e('Insert Single Ad', SAM_DOMAIN); ?></title>
...
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
  <form name="svb" onsubmit="insertSAMAdCode();return false;" action="#">
    <div class="tabs">
      <ul>
    ...
    <div class="panel_wrapper" style="height: 200px;">
      <div id="basic_panel" class="panel current">
		    <table border="0" cellpadding="4" cellspacing="0">
		      <tr>
			      <td nowrap="nowrap"><label for="sam_id"><?php echo __('Ad', SAM_DOMAIN).':'; ?></label></td>
			      <td>
      ...
      <div style="float: right">
        <input type="submit" id="insert" name="insert" value="<?php _e("Insert", SAM_DOMAIN); ?>" onclick="insertSAMAdCode();" />
      </div>
    </div>
  </form>
