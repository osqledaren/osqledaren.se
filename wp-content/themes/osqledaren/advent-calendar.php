...
<div id="adv_cal" class="page_content container">
    ...
    <?php else : ?>
        <div class="advent-div active">
            <div class="adv_cal_nr">1<small>advent</small><div class="lock"><img src="http://img.youtube.com/vi/<?php echo youtube_id_from_url(get_option('osq_cal_adv_1'))?>/sddefault.jpg"/></div></div>
    <?php endif; ?>
            <?php if($array[1]) :  ?>
    ...
    <?php else : ?>
        <div class="advent-div active">
            <div class="adv_cal_nr">2<small>advent</small><div class="lock"><img src="http://img.youtube.com/vi/<?php echo youtube_id_from_url(get_option('osq_cal_adv_2'))?>/sddefault.jpg"/></div></div>
    <?php endif; ?>
            <?php if($array[2]) :  ?>
    ...
    <?php else : ?>
        <div class="advent-div active">
            <div class="adv_cal_nr">3<small>advent</small><div class="lock"><img src="http://img.youtube.com/vi/<?php echo youtube_id_from_url(get_option('osq_cal_adv_3'))?>/sddefault.jpg"/></div></div>
    <?php endif; ?>
            <?php if($array[3]) :  ?>
