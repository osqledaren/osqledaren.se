...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_combined_css', get_template_directory_uri() . '/assets/css/combined.css', false, null);
  ...
  wp_register_script('roots_main', get_template_directory_uri() . '/assets/js/main.min.js', false, null, true);
  wp_enqueue_script('roots_plugins');
  wp_enqueue_script('roots_main');
  // wp_register_script('roots_combined_js', get_template_directory_uri() . '/assets/js/combined.min.js', false, null, false);
  // wp_enqueue_script('roots_combined_js');
}
