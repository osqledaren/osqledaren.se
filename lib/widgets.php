...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id' => 'sidebar-banner',
    'description'   => 'Här ska Senaste Numret widgeten finnas.',
  ...
  register_sidebar(array(
    ...
    'id' => 'sidebar-primary',
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget' => '<div style="clear:both;"></div></div></section>',
    'before_title' => '<h3 class="widget-title">',
    'after_title' => '</h3><div class="widget-inner">',
  ));
  // register_sidebar(array(
  ...
  register_sidebar(array(
    'name'        => __('Ads Banner'),
    'description'     => __('Sidofält för annonser (1170x144px). Ladda upp bilder i Mediebiblioteket och lägg in dem i en Text-widget som &lt;a href="..."&gt;&lt;img...&gt;&lt;/a&gt;. Sätt ingen titel.'),
    'before_widget'   => '<div id="banner-ad" class="container ad Advertisement advBox">' . "\n",
    'after_widget'    => '</div>' . "\n",
    'before_title'    => '<h3 class="hide">',
    'after_title'     => '</h3>' . "\n",
  ));
  register_sidebar(array(
    'name'        => __('Ads Mobile Banner'),
    'description'     => __('Sidofält för annonser (770x168px). Ladda upp bilder i Mediebiblioteket och lägg in dem i en Text-widget som &lt;a href="..."&gt;&lt;img...&gt;&lt;/a&gt;. Sätt ingen titel.'),
    'before_widget'   => '<div id="banner-mob-ad" class="container ad Advertisement advBox">' . "\n",
    'after_widget'    => '</div>' . "\n",
    'before_title'    => '<h3 class="hide">',
    'after_title'     => '</h3>' . "\n",
  ));
  // register_sidebar(array(
  // 'name'        => __('Ads Sidebar'),
  // 'description'     => __('Sidofält för annonser (370x240). Ladda upp bilder i Mediebiblioteket och lägg in dem i en Text-widget som &lt;a href="..."&gt;&lt;img...&gt;&lt;/a&gt;.'),
  // 'before_widget'   => '<div id="%1$s" class="ad Advertisement advBox %2$s">' . "\n",
  // 'after_widget'    => '</div>' . "\n",
  // 'before_title'    => '<h3 class="hide">',
  // 'after_title'     => '</h3>',
  // ));
  register_sidebar(array(
    'name'        => __('Ads Feed'),
    'description'     => __('Fält för annonser (770x168px), syns mellan nyhet två och tre på förstasidan. Ladda upp bilder i Mediebiblioteket och lägg in dem i en Text-widget som &lt;a href="..."&gt;&lt;img...&gt;&lt;/a&gt;. Sätt ingen titel.'),
    'before_widget'   => '<div id="feed-ad" class="ad Advertisement advBox">' . "\n",
    'after_widget'    => '</div>' . "\n",
    'before_title'    => '<h3 class="hide">',
    'after_title'     => '</h3>' . "\n",
  ));
